...
class HospitalManage extends React.Component<HospitalManageProps> {
  ...
  toPage = (newPage?: number) => {
    ...
    this.props.fetchList({
      'begin_time': getDateStr(this.state.createStartDate),
      'end_time': getDateStr(this.state.createEndDate),
      'hospital_city': this.state.city,
      'hospital_id_str': this.state.hospital,
      'hospital_province': this.state.province,
  ...
  handleExportExcel = () => {
    exportExcel('/export/hospital/list', {
      begin_time: getDateStr(this.state.createStartDate),
      end_time: getDateStr(this.state.createEndDate),
      hospital_city: this.state.city,
      hospital_id_str: this.state.hospital,
    ...
    return (
      <div className="app-function-page">
        ...
        <div className="toolbar">
          ...
          <div>
            <SearchBox label="医院" placeholder="输入名称查询"
        ...
        <div className="query-filter">
          ...
          >
            ...
            />
            <SelectedItem
              label="医院" value={this.state.hospital} options={hospitalList}
              onReset={() => this.setState({hospital: ''})}
            />
            <SelectedItem
